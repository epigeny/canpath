...
<#macro dataAccessProcessModel>
  ...
  <div class="card card-info card-outline mt-5 mb-5 p-0">
    <div class="accordion" id="accessProcessAccordion">
      <div class="card mb-0">
        <div class="card-header">
          <button type="button" class="btn btn-link btn-block text-navy text-left" data-toggle="collapse" data-target="#collapseOne">Access Criteria &amp; Requirements</button>
        </div>
      ...
      <div class="card mb-0">
        <div class="card-header">
          <button type="button" class="btn btn-link btn-block text-navy text-left" data-toggle="collapse" data-target="#collapseTwo">Harmonized Datasets</button>
        </div>
      ...
      <div class="card mb-0">
        <div class="card-header">
          <button type="button" class="btn btn-link btn-block text-navy text-left" data-toggle="collapse" data-target="#collapseFour">Expedited Review Criteria</button>
        </div>
      ...
      <div class="card mb-0">
        <div class="card-header">
          <button type="button" class="btn btn-link btn-block text-navy text-left" data-toggle="collapse" data-target="#collapseFive">Full Access Review Criteria</button>
        </div>
      ...
      <div class="card mb-0">
        <div class="card-header">
          <button type="button" class="btn btn-link btn-block text-navy text-left" data-toggle="collapse" data-target="#collapseSeven">Access Cost</button>
        </div>
        <div id="collapseSeven" class="collapse" data-parent="#accessProcessAccordion">
          <div class="card-body">
            <p>
              ...
              Applicants are invited to complete a <a href="https://canpath.ca/wp-content/uploads/2026/04/CanPath-Inquiry-form-17April2026.pdf" target="_blank">Inquiry Form</a> and submit by email to <a href="mailto:access@canpath.ca">access@canpath.ca</a>.
            </p>
          </div>
        </div>
      </div>
