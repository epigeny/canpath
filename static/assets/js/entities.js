...
const StatItemComponent = {
  ...
  template: `
    <a v-if="count" v-bind:href="url" class="btn btn-sm btn-link text-info col text-left">
    ...
    <div class="typeahead w-100 position-relative">
      <div class="input-group">
        ...
        <div class="input-group-append">
          <button type="button" class="btn btn-info btn-sm" @click="select(text)"><i class="fas fa-filter"></i></button>
        </div>
